/**
 * ============================================================================
 * K9 Harmony - Frontend Configuration 1739
 * ============================================================================
 * フロントエンド用の設定ファイル
 * 最終更新: 2026-01-08
 */
...
const FRONTEND_CONFIG = {
  ...
  API: {
    ...
    BASE_URL: 'https://script.google.com/macros/s/AKfycby5nbPNJ_Tc_lA6TFNDRn9g6ZpMN7As1ldsa9eCreZuCFWzvTRjqij3DDrhzcvolk_6JA/exec',
    TIMEOUT: 30000 // 30秒
  },

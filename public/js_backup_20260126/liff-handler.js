...
class LiffHandler {
    ...
    async init() {
      try {
        ...
        await liff.init({
          liffId: FRONTEND_CONFIG.LIFF.LIFF_ID
        });
        ...
        throw new Error(FRONTEND_CONFIG.ERROR_MESSAGES.LIFF_INIT_FAILED);
      }
    }
    ...
    getAccessToken() {
      if (!this.accessToken) {
        throw new Error(FRONTEND_CONFIG.ERROR_MESSAGES.NOT_LOGGED_IN);
      }
